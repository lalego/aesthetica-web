        ...
        <div className="prose prose-neutral max-w-none space-y-8 text-neutral-600 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-1 pl-4 list-disc">
              ...
              <li><strong>Nombre comercial:</strong> Clínica AestheticA</li>
          ...
          <section className="space-y-3">
            ...
            <p>El presente Aviso Legal regula el acceso y uso del sitio web <strong>aesthetica-web.pages.dev</strong> (en adelante, "el Sitio Web"), titularidad de Alena Martseniuk, que ofrece información sobre los servicios de estética avanzada de Clínica AestheticA.</p>
          ...
          <section className="space-y-3">
            ...
            <p>La información publicada en este Sitio Web tiene carácter orientativo. Clínica AestheticA no se responsabiliza de los daños derivados del uso del Sitio Web, ni de posibles errores en los contenidos. Los resultados de los tratamientos pueden variar según cada persona.</p>
          </section>
